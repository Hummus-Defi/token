...
import './interfaces/IMasterHummusV2.sol';
    ...
    IMasterHummusV2
{
    ...
    struct PoolInfo {
        ...
        // Note : beware storage collision with old MasterHummus
        uint256 adjustedAllocPoint; // Adjusted allocation points for this pool. HUMs to distribute per second.
    }
    ...
    function setNewMasterHummus(IMasterHummusV2 _newMasterHummus) external onlyOwner {
        ...
        )
    {
        ...
        if (block.timestamp > pool.lastRewardTimestamp && lpSupply != 0) {
            ...
            uint256 humReward = (secondsElapsed * humPerSec * pool.adjustedAllocPoint) / totalAdjustedAllocPoint;
